    ...
    <div class="container-fluid">
         <div class="card mt-3 shadow cs-list-header">
             <div class="card-header">
                 <h3><i class="fa fa-cogs mr-2"></i><?= $title ?>
                     <p class="small"><?= $count . _(" orden(es) hallada(s)."); ?></p>
                 </h3>

                 <div class="row">
                     <div class="col mx-auto text-center">
                         <a href='<?= base_url("myorders/topdf") ?>' id='topdf' class='btn cs-list-btn d-block d-md-inline-block'>
         ...
         <div class="card cs-list-filter">
            ...
            <div id="collapseOne" class="collapse show" aria-labelledby="headingOne">
               <div class="card-body">
                  <?= form_open("myorders/search",'class="form-horizontal" id="searchForm" role="form"') ?>
                  ...
                  <div class="form-group row">
                       <label class="col-md-3 col-sm-12 mt-1 col-form-label"><?= _("Cliente") ?></label>
                       <?= form_dropdown('cust_id', $customers,(isset($vars['cust_id']) ? $vars['cust_id'] : ''),
                                               "class='form-control custom-select col-md-8 col-sm-8 ml-2' id='cust_id'"); ?>
                  </div>
           ...
           <div class="card h-100 text-center">
                 ...
                 <div class="card-body h-100 text-white" style="background-color: black">
                   <div class="text-center mb-2">
                       <a href="<?= base_url("myorders/view/$id")?>" style='text-decoration: none; color: inherit'
                           class="btn btn-app">
