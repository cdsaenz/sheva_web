                           ...
                           <div class="col-xs-12 col-md-10 text-center mx-auto">
                                ...
                                <div class="row">
                                    <div class="col mx-auto text-center">
                                      <a href="<?= base_url("items/edit/$id") ?>" class="btn btn-dark float-center action-button3">
                                          <i class="fas fa-pen-square"></i>
                                          <div class="small"><?= _("Editar") ?></div>
                                      </a>
                                      <a href="<?= base_url("items") ?>" class="btn btn-dark float-center action-button3">
                            ...
                            <div class="tab-pane fade mt-3 ml-2" id="pictures" role="tabpanel" aria-labelledby="pictures-tab">
                                <div class="container-fluid">
                                 <div class="card  mx-auto text-center">
                                     <div class="card-body cs-view-body">
                                       <a href="<?= base_url("media/add/items/$id") ?>" class="btn btn-primary align-middle action-button3">
                                      ...
                                      <?php foreach ($media as $medium) : ?>
                                         <div class="col-lg-3 col-md-4 col-xs-6 mt-2">
                                          <div class="card mx-auto text-center d-block">
                                            ...
                                            <div class="card-body cs-view-body">
                                                 <h5 class="card-title"><?= $medium['media_type'] ?><br /><?= ($medium['is_main'] == 'Y' ? '<b>Principal</b>' : 'Secundaria') ?></h5>
